      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <Field
          label={
            <>
              Clinical notes
              <InfoTip text="When on, new visits are flagged for a clinical note until one is completed — filterable via Ledger's 'Not documented' checkbox. This doesn't turn note-taking on or off — staff can always open 'New note' from a patient's profile either way; it only controls the per-visit reminder. Off by default; turn on for clinics that track a note per visit." />
            </>
          }
        >
          <BoolToggle
